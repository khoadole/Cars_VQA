...
def train():
    ...
    # Add data for save
    vocab_size = dataLoader["train"].dataset.qu_vocab.vocab_size
    num_classes = dataLoader["train"].dataset.qu_vocab.answer_size
    embeddings = dataLoader["train"].dataset.qu_vocab.get_embeddings()
    ...
    # MODEL
    model = resnet_LSTM(vocab_size=vocab_size, num_classes=num_classes, embeddings=embeddings, word_embed=300, lstm_hidden=32)
